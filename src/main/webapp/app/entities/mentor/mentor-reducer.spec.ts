...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './mentor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENTOR actions', async () => {
    ...
    it('dispatches UPDATE_MENTOR actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_MENTOR actions', async () => {
    ...
    it('dispatches DELETE_MENTOR actions', async () => {
      const arg = 42666;

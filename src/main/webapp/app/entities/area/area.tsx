  ...
  return (
    <div>
      <h2 id="area-heading" data-cy="AreaHeading">
        <Translate contentKey="apoiaBackOfficeApp.area.home.title">Areas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="apoiaBackOfficeApp.area.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/area/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="apoiaBackOfficeApp.area.home.createLabel">Create new Area</Translate>
          </Link>
        </div>
      </h2>
        ...
        {areaList && areaList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="apoiaBackOfficeApp.area.id">Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="apoiaBackOfficeApp.area.home.notFound">No Areas found</Translate>
            </div>
          )
        )}
      </div>

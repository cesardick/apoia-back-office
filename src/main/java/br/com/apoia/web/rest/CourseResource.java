...
import br.com.apoia.service.CourseService;
...
/**
 * REST controller for managing {@link br.com.apoia.domain.Course}.
 */
@RestController
...
public class CourseResource {
    ...
    public ResponseEntity<CourseDTO> createCourse(@RequestBody CourseDTO courseDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/courses/" + courseDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, courseDTO.getId()))
            .body(courseDTO);
    }
    ...
    public ResponseEntity<CourseDTO> updateCourse(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, courseDTO.getId()))
            .body(courseDTO);
    }
    ...
    public ResponseEntity<CourseDTO> partialUpdateCourse(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, courseDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CourseDTO> getCourse(@PathVariable("id") String id) {
